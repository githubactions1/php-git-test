...
class Frtemployees extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('frtemployees/ftpemployees',$data);
	...
	public function add()
	{
		...
		$data['page_name']='Add';	
		$this->load->view('frtemployees/frtemployee_add',$data);
		$this->load->view('footer');
		}else{
			 redirect('Welcome');	
		}
	...
	public function get_all_states_list(){
		...
		$curl = curl_init();
		curl_setopt_array($curl, array(
		CURLOPT_URL => API_MAIN_URL.'employees/frtinsertemployee',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 0,
	...
	//end
		$curl = curl_init();
		curl_setopt_array($curl, array(
		CURLOPT_URL => API_MAIN_URL.'employees/frtupdateemployee',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 0,
...
return $response;
		...
		public function employees_download_data(){
				...
				$employee_data= json_decode($this->get_frtall_employees_list());
	...
	public function edit($emp_id)
	{
		...
		$this->load->view('frtemployees/frtemployee_edit',$data);
		$this->load->view('footer');
		}else{
			 redirect('Welcome');	
		}
