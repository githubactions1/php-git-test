<form class="needs-validation" action="<?php echo base_url();?>Tasks/hard_ware_used_update" method="post">
			<div class="row">
			<div class="col-12">
			<div class="row">
			...
			?> 
			<option value="<?php echo $hardware_cat->sub_cat_id;?>" <?php if($data->cat_id == $hardware_cat->sub_cat_id){ echo 'selected'; }?> ><?php echo $hardware_cat->sub_cat_name?></option>
			<?php } } ?>
			</select>
			</div>
			...
			<option value="" >Select</option>
			<?php 
			if(!empty($hardware_list_data)){
			foreach($hardware_list_data as $key2=>$hardware_lis){
			?> 
			<option value="<?php echo $hardware_lis->part_code;?>" <?php if($data->hw_partcode == $hardware_lis->part_code){ echo 'selected'; }?> ><?php echo $hardware_lis->part_code?></option>
			<?php } } ?>
			</select>
			...
			<input class="form-control" type="text" name="hw_desc" id="hw_desc"  placeholder="Name"  value="<?php echo $data->hw_desc;?>" required readonly>
			...
			<input class="form-control" type="text" name="no_of_units_used" id="no_of_units_used"  value="<?php echo $data->no_of_units_used;?>" placeholder="Value" required>
