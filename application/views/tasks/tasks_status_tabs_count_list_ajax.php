...
<?php } if($task_status_tabs_cpount->Access_Not_Available_402 > 0){?>
<li><a href="javascript:void(0)" onclick="get_tasks_status_set(402)" class="nav-link <?php if($task_status==402) { echo 'active'; }?>"><i class="mdi mdi-checkbox-blank-circle " style="color: #dd4a4a!important;"></i> Access Not Available - <?php echo $task_status_tabs_cpount->Access_Not_Available_402;?> </a> </li>
...
<li><a href="javascript:void(0)" onclick="get_tasks_status_set(224)" class="nav-link <?php if($task_status==224) { echo 'active'; }?>"><i class="mdi mdi-checkbox-blank-circle " style="color: #1d6dda!important;"></i> Checklist Submitted- <?php echo $task_status_tabs_cpount->Checklist_Submited_224;?> </a> </li>
...
<?php } if($task_status_tabs_cpount->Reject_416 > 0){?>
<li><a href="javascript:void(0)" onclick="get_tasks_status_set(416)" class="nav-link <?php if($task_status==416) { echo 'active'; }?>"><i class="mdi mdi-checkbox-blank-circle " style="color:#e71c5a!important;"></i> Reject - <?php echo $task_status_tabs_cpount->Reject_416;?> </a> </li>
