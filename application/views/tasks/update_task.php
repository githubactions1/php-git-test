            ...
            <div class="card-body">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-3">
				  ...
				  if($primary_task_status_check == 227 || $primary_task_status_check == 416){
                ...
                <div class="col-md-5">
				 ...
				 <?php } ?>
				  ...
				  <table class="cts bg-light">
					...
					<td><strong>
					<?php if(($task_details->task_status=='227') || ($sub_task_status_names[$key]=='Approved') || ($sub_task_status_names[$key]=='Removed') || ($primary_task_status=='Approved') || ($primary_task_status=='Rejected(ServiceNow)') || ($primary_task_status_id=='416') || ($primary_task_id != $sub_task_id[$key] && $sub_task_status_names[$key] == 'Field Cancel')){ ?>
              ...
              <div class="mb-3 row">
				 ...
				 <?php if(empty($task_hardware_used_data)){ ?>
                  <p class="b-heafd" >Hardware Used <?php if($task_details->primary_task_status_id ==226){ ?>
					  <a href="javascript:void(0)" class="btn btn-success" data-bs-toggle="modal" data-bs-target=".bs-example-modal-hardware_note_add" onclick='getTask_hardware_add(<?php echo $task_details->task_id;?>,0)' title="Add Hardware" > <i class="fas fa-plus"></i></a> <?php } ?></p> 
				 ...
				 <?php }  if(!empty($task_hardware_used_data)){ ?>
				   <div class="row">
                    ...
                    <div class="col-md-4">
                      <p class="b-heafd" >used units 
					  <?php if($task_details->primary_task_status_id ==226){ ?>
					  <a href="javascript:void(0)" class="btn btn-success" data-bs-toggle="modal" data-bs-target=".bs-example-modal-hardware_note_add" onclick='getTask_hardware_add(<?php echo $task_details->task_id;?>,0)' title="Add Hardware" > <i class="fas fa-plus"></i></a> <?php } ?>
                  ...
                  <div class="row">
					...
					<?php if($task_details->primary_task_status_id <=226){ ?>
                    <div class="col-md-1"> 
                      <p><a href="#" data-bs-toggle="modal" data-bs-target=".bs-example-modal-hardware_note_edit" onclick='getTask_hardware_details(<?php echo $task_details->task_id;?>,<?php echo $task_hardware->id;?>)'> <i class="fas fa-edit"></i></a></p>
                    </div>
					<?php } ?>
                  </div>
					<?php } } } ?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <div class="desc">
                                 <p>
									<?php if(!empty($task_log->task_status_name)){ ?>
									<?php echo $task_log->comments;?>
									<?php }else {
										$tasks_docs=explode('Attachment:',$task_log->comments);
										if(!empty($tasks_docs[0])){
											echo $tasks_docs[0];
										}
										if(!empty($tasks_docs[1])){	
										echo "<a href='".$tasks_docs[1]."' target='_blank' class='btn btn-sm btn btn-success'>Attachment</a>";
										}
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="reso">
              <div class="row">
                <div class="col-md-6">
                  <h6 class="text-white"><?php echo substr($task_details->task_type_name, 0,2);?> &nbsp 
			<?php  if(!empty($task_check_list)){ 
				if($task_details->task_type == 352 || $task_details->task_type == 564){
					if($primary_task_status_check < 227){
			?>
			 <a href="javascript:void(0)" class="text-white" data-bs-toggle="modal" data-bs-target=".bs-example-modal-checklist_edit" onclick='getcheck_list_details(<?php echo $task_details->task_id;?>)'> <i class="fas fa-pencil-alt"></i></a>
			<?php } } }  ?>
				 </h6>
                </div>
                <div class="col-md-6">
		...
		<?php 
              ...
              <div class="mb-1 row">
				...
				foreach($image_signs as $key12=>$image_sig){
					...
					$img2 =str_replace("STT",",STT",$image_sig);
					$img1= str_replace("httpsify.digitalrupay.comchecklistimagesProd,","http://sify.digitalrupay.com/checklistimagesProd/",$img2);
					$or_no=$task_details->service_no;		
					$img11= str_replace("offrimg","offr_img_",$img1);
					$or_no1=$or_no.'_';
					$img111= str_replace($or_no,$or_no1,$img11);
					if($task_check_list->i_ts >= '2023-07-26' && $task_check_list->i_ts <= '2023-08-02'){
					$image_sig=$img111;
					}
  ...
  <div class="modal fade bs-example-modal-documents_add" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
		...
		<form class="needs-validation" action="<?php echo base_url();?>Tasks/add_notes_images_data/1" method="post" enctype="multipart/form-data">        
		<div class="row">
          <div class="col-12">
          <div class="row">
           <div class="col-md-4">
          ...
          <!-- end col -->
			...
			<input class="form-control" type="hidden" name="task_id" id="task_id"  value="<?php echo $task_details->task_id;?>" >
			<input class="form-control" type="hidden" name="primary_task_id" id="primary_task_id"  value="<?php echo $task_details->primary_task_id;?>" >
			<input class="form-control" type="hidden" name="note" id="note"  value="" >
<input class="form-control" type="hidden" name="attachment_counts" id="attachment_counts"  value="0" >
...
<div class="col-sm-6 col-md-3 mt-4"> 
  <!--  Modal content for the above example -->
  <div class="modal fade bs-example-modal-hardware_note_edit" tabindex="-1" role="dialog"
                                    aria-labelledby="myLargeModalLabel" aria-hidden="true" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mt-0">Hardware Used Edit  </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-hidden="true"></button>
        </div>
			<div class="modal-body">
			<div id="hardware_list_div">
				please Wait ...
			</div>
</div>
</div>
...
<div class="col-sm-6 col-md-3 mt-4"> 
  <!--  Modal content for the above example -->
  <div class="modal fade bs-example-modal-hardware_note_add" tabindex="-1" role="dialog"
                                    aria-labelledby="myLargeModalLabel" aria-hidden="true" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mt-0">Hardware Used Add  </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-hidden="true"></button>
        </div>
			<div class="modal-body">
			<div id="hardware_add_div">
				please Wait ...
			</div>
</div>
</div>
...
<div class="col-sm-6 col-md-3 mt-4"> 
  <!--  Modal content for the above example -->
  <div class="modal fade bs-example-modal-checklist_edit" tabindex="-1" role="dialog"
                                    aria-labelledby="myLargeModalLabel" aria-hidden="true" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" style="display: none;">
   <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title mt-0">Check list Edit (<?php echo $task_details->task_no;?>)</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-hidden="true"></button>
        </div>
			<div class="modal-body">
			<div id="check_list_edit_div">
				please Wait ...
			</div>
</div>
</div>
...
function get_task_checklist_imng_pop(encode_img){	
			...
			$('.bs-example-modal-checklist_edit').modal('hide');
				$.ajax({
				type: "POST",    
				dataType: "html",    
...
function getTask_hardware_details(task_id,hardware_id){	
			var service_no="<?php echo $task_details->service_no; ?>";
			if(hardware_id != ''){
					$.ajax({
				type: "POST",    
				dataType: "html",    
				url: "<?php echo site_url(); ?>Tasks/get_task_hardware_details_data",    
				data: {task_id:task_id,hardware_id:hardware_id,service_no:service_no }})
				.done(function(data){

				$('#hardware_list_div').html(data);
				});
...
function getTask_hardware_add(task_id,hardware_id){	
			var service_no="<?php echo $task_details->service_no; ?>";
			if(hardware_id == '0'){
					$.ajax({
				type: "POST",    
				dataType: "html",    
				url: "<?php echo site_url(); ?>Tasks/get_task_hardware_details_add",    
				data: {task_id:task_id,hardware_id:hardware_id,service_no:service_no }})
				.done(function(data){

				$('#hardware_add_div').html(data);
				});
...
function addImage(key)
	{	
		var attachment_counts=$("#attachment_counts").val();
		...
		$.ajax({    
			...
			$('#attachment_counts').val(attachment_counts1);
		});
	}
...
function getcheck_list_details(task_id){	
			
			if(task_id != ''){
					$.ajax({
				type: "POST",    
				dataType: "html",    
				url: "<?php echo site_url(); ?>Tasks/get_task_check_list_details_data",    
				data: {task_id:task_id}})
				.done(function(data){

				$('#check_list_edit_div').html(data);
				});
