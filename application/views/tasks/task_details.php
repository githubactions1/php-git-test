            ...
            <div class="card-body">
              <div class="mb-3 row" style="border-bottom: solid 1px #ccc; padding-bottom: 10px;">
                ...
                <div class="col-md-2 back">
                  ...
                  <a href="<?php echo base_url();?>Tasks"><i class="fa fa-arrow-left text-white"></i> <span class="text-white">Back</span></a>
                  </button>
                </div>
              </div>
              <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                <div class="col-md-3">
                  ...
                  <div><span class="btn btn-dark"><?php echo $task_details->primary_task_status;?> </span></div>
                </div>
                <div class="col-md-3">
                  <p>Documents</p>
                  <h6 >
                ...
                <div class="col-md-5">
				 ...
				 <?php } ?>
				  ...
				  <table class="cts bg-light">
					...
					<?php echo $sub_task_status_names[$key];?>
					<?php } else { ?>
					<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target=".bs-example-modal-change_status" onclick='getCHange_task_status_pop("<?php echo $sub_task_id[$key];?>")'> <?php echo $sub_task_status_names[$key];?> </a> 
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <div class="desc">
                                  ...
                                  <p><?php echo " Travelled: ".$task_log->travel_distance;?></p><?php }?>
                                </div>
                              </div>
      ...
      <div class="col-xl-4">
        <div class="card">
          <div class="card-body">
			...
			<?php  
				// echo '<pre>';print_r($task_check_list);exit; 

			if(!empty($task_check_list)){ 
			foreach($task_check_list as $keyd=>$task_check_list_k){
			?>
            <div class="chcklist-new"  id="contact">
		<?php 
				$task_check_list_final1=$task_check_list_k->form_tabs;
				
				$image_signs1=$task_check_list_k->images_tabs;
                      ...
                      <div class="task">
                        <ul class="sessions">
						  ...
						  <li>
                            ...
                            <p><?php echo Datetimeconversion($task_log->tl_date_created);?><br><?php echo $task_log->comments;?><br><?php if($task_log->travel_distance!=''){ ?><?php echo " Travelled: ".$task_log->travel_distance;?><?php }?></p>
                          </li>
