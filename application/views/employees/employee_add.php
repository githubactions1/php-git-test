              ...
              <div class="card-body">
                ...
                <div class="mb-2 row">
				  ...
				  <div class="col-md-3">
                    ...
                    <input class="form-control" type="number" name="po_number" id="po_number" value="<?php echo $employee_record->po_number;?>" placeholder="PO Number"  data-parsley-required-message="PO Number">
                  </div>
				  	
				  
                  <div class="col-md-3">
                    <label class="col-form-label">Effective Date</label>
                    <input class="form-control" type="date" name="effective_date" id="effective_date" value="<?php echo $employee_record->effective_date ;?>" placeholder="Effective Date " data-parsley-required-message="Enter Effective Date">
                  </div>
				  <div class="col-md-3">
                    <label class="col-form-label">Expiry Date</label>
                    <input class="form-control" type="date" name="expry_date" id="expry_date" value="<?php echo $employee_record->expry_date ;?>" placeholder="Expiry Date "   data-parsley-required-message="Enter Expiry Date">
                  </div>
                    ...
                    <select class="form-control select2" id="team_type" name="team_type"    data-parsley-required="true"   data-parsley-required-message="Select Team Type">
                      <option value="" >Select Type</option>
						...
						foreach($team_types_list as $team_type_row_key=>$team_type_row){
							if($team_type_row->sub_cat_id!=417 && $team_type_row->sub_cat_id!=418)
							{
						?> 
...
var SampleJSONData3 = [
	...
	?> 
   {
	...
	$.ajax({  
		type: "POST",
		url: '<?php echo base_url();?>Employees/get_cluster_wsie_shifts_list', 
		data: "cluster_ids="+cluster_ids,
		complete: function(dd){  
			var op = dd.responseText.trim();
...
jQuery(document).ready(function($) {
		...
		$("#employee_create_form").on("submit", function(e){
				...
				$.ajax({
					type: "post",
					url:"<?php echo base_url()?>Employees/add_employee_submit_form_ajax",
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>Employees"; },2000);
