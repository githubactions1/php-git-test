                    ...
                    <select class="form-control select2" id="team_type" name="team_type"    data-parsley-required="true"   data-parsley-required-message="Select Team Type">
                      <option value="" >Select Type</option>
						...
						<?php //} } ?>-->
						 ...
						 <option value="418"<?php if($employee_record->team_type==418){ echo 'selected';}?>>FRT Team</option>
						 <option value="417"<?php if($employee_record->team_type==417){ echo 'selected';}?>>Patroller</option>
