...
<option value="8"  <?php if (8== $_POST['status_id']){
echo 'selected="selected"';
}?>>Comp-off</option>
<option value="9"  <?php if (9== $_POST['status_id']){
echo 'selected="selected"';
}?>>Holiday</option>
...
<?php 
if($teamdetails->attendence_id != '' || $teamdetails->attendence_id != null){
	$attendence_id=$teamdetails->attendence_id;
}else{
	$attendence_id='0';
}
...
if($type_n==0){
if($teamdetails->emp_sts==1 || $attendence_id=='0'){
	//echo "Absent";
...
else if($teamdetails->emp_sts==2)
{
	//echo "Weekly Off";
	$emp_sts_name="Not Available";
}
else if($teamdetails->emp_sts==5)
{
	//echo "Comp-off";
	$emp_sts_name="Not Available";
}
else if($teamdetails->emp_sts==6)
{
	//echo "Holiday";
	$emp_sts_name="Not Available";
}
...
<?php echo Datetimeconversion($teamdetails->updated_on);?></div>

<div class="diagnostic-container">
<div class="margin-top-05 pre-wrapped"><span data-toggle="tooltip" data-placement="top" title="High accuracy setting is <?php if($permission_details['Accuracy']<100){ echo 'on'; } else { echo 'off'; }?>"><span class="device-settings-icon accuracy-<?php if($permission_details['Accuracy']<100){ echo 'active'; } else { echo 'deactive'; }?>"></span></span><span data-toggle="tooltip" data-placement="top" title="Battery optimization setting is <?php if($permission_details['battery']>=50) { echo 'on'; } else { echo 'off'; }?>"><span class="device-settings-icon battery-optimize-<?php if($permission_details['battery']>=50) { echo 'active'; } else { echo 'deactive'; }?>"></span></span><span data-toggle="tooltip" data-placement="top" title="GPS is <?php if($permission_details['gps_per']=='0'){ echo 'on'; }else { echo 'off'; }?>"><span class="device-settings-icon gps-<?php if($permission_details['gps_per']=='0'){ echo 'active'; }else { echo 'deactive'; }?>"></span></span><span data-toggle="tooltip" data-placement="top" title="Network is <?php if($permission_details['nearby_device']=='0'){ echo 'on'; }else { echo 'off'; }?>"><span class="device-settings-icon network-<?php if($permission_details['nearby_device']=='0'){ echo 'active'; }else { echo 'deactive'; }?>"></span></span><span class="storage-permission"><span data-toggle="tooltip" data-placement="left" title="Files and Storage permission is <?php if($permission_details['file_per']=='0'){ echo 'granted'; }else { echo 'denied'; }?>."><span class="device-settings-icon storage-<?php if($permission_details['file_per']=='0'){ echo 'active'; }else { echo 'deactive'; }?>"></span></span></span></div>
...
<a href="javascript:void(0)" class="btn btn-success" data-bs-toggle="modal" data-bs-target=".bs-example-modal-team_status_sow" onclick='getTeam_status_show_pop(<?php echo $teamdetails->emp_id;?>,<?php echo $attendence_id;?>)'>
 <?php echo $emp_sts_name;?>
 </a>
...
<div class="col-sm-6 col-md-3 mt-4"> 
<!--  Modal content for the above example -->
<div class="modal fade bs-example-modal-team_status_sow" tabindex="-1" role="dialog"
      aria-labelledby="myLargeModalLabel" aria-hidden="true">
<div class="modal-dialog modal-team_status_sow">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title mt-0" id="myLargeModalLabel">Update Attendance</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal"
                      aria-hidden="true"></button>
</div>
<div class="modal-body">
...
function getTeam_status_show_pop(emp_id,attendence_id){	
	if(emp_id != ''){
	$.ajax({
	type: "POST",    
	dataType: "html",    
	url: "<?php echo site_url(); ?>Team/get_present_emp_login_details_ajax",    
	data: {emp_id:emp_id,attendence_id:attendence_id }})
	.done(function(data){

	$('#status_list_div').html(data);
	});
	}
}
</script> 
