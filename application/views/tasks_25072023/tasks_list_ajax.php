                          ...
                          <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                              ...
                              <tr>
								...
								<td><strong>
								<?php if(($task_row->task_status=='227') || ($sub_task_status_names[$key1]=='Approved') || ($sub_task_status_names[$key1]=='Removed') || ($primary_task_status=='Rejected(ServiceNow)') || ($primary_task_status=='Approved') || ($primary_task_id != $sub_task_id[$key1] && $sub_task_status_names[$key1] == 'Field Cancel')){ ?>
								...
								<?php if(($sub_task_status_name_ids[$key1]=='227') || ($sub_task_status_name_ids[$key1]=='408') || ($primary_task_status_id=='407') || ($primary_task_status_id=='271') || ($primary_task_status_id=='227')){ } else {?>
                                ...
                                <td><button type="button" class="btn btn-success">
                                  <a href="<?php echo base_url();?>Tasks/task_details/<?php echo $task_row->task_id;?>"><i class="far fa-eye text-white"></i></a>
                                  </button>
