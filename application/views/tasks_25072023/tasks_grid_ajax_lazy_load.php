...
<?php if(($task_row->task_status=='227') || ($sub_task_status_names[$key1]=='Approved') || ($sub_task_status_names[$key1]=='Removed') || ($primary_task_status=='Approved') || ($primary_task_status=='Rejected(ServiceNow)') || ($primary_task_id != $sub_task_id[$key1] && $sub_task_status_names[$key1] == 'Field Cancel')){ ?>
...
<td>
<?php  if(($primary_task_id == $sub_task_id[$key1]) && $primary_task_status!='271') { ?>
