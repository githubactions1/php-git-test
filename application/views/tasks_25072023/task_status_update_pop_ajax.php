              ...
              <div class="col-12">
			   ...
			   <div class="col-12">
					...
					foreach($task_status_list as $key=>$taskstatus1){ ?> 
						...
						<?php if($task_details->task_status == 222 && ($taskstatus1->sub_cat_id == 224 || $taskstatus1->sub_cat_id == 271 || $taskstatus1->sub_cat_id == 226 || $taskstatus1->sub_cat_id == 272 || $taskstatus1->sub_cat_id == 223)){ ?> 
						<option value="<?php echo $taskstatus1->sub_cat_id;?>"><?php echo $taskstatus1->sub_cat_name?></option>
						<?php }  ?>
						...
						<?php if($task_details->task_status == 226 && ($taskstatus1->sub_cat_id == 227 || $taskstatus1->sub_cat_id == 272)){ ?> 
						<option value="<?php echo $taskstatus1->sub_cat_id;?>"><?php echo $taskstatus1->sub_cat_name?></option>
						<?php }  ?>
