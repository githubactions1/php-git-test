                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group typebtn"> 
                            ...
                            <select class="form-select" aria-label="Default select example"  name="report_type" id="report_type" onChange="Get_reports_wise_div()">
								...
								<option value="3">Cluster Performance Report</option>
								<option value="2" >Employee Reports</option>
								<option value="4">Task Dump Report</option>
								<option value="6">Location History</option>
								<option value="5">Managers Attendance History(Backend)</option>
                            </select>
...
var SampleJSONData2 = [
	...
	if($employee->team_type!=417 && $employee->team_type!=418) {
	?> 
   {
