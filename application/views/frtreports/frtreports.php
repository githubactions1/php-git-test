...
<form action="<?php echo base_url()?>FrtReports/reports_download_ajax" method="post"  id="filters_form"  onsubmit="reports_download_form()">
...
<a href="<?php echo base_url();?>FrtReports" class="btn btn-success waves-effect waves-light">Cancel</a>
</div>
</div>
</div>
</div>
