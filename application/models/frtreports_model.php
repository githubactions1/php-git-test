...
class Frtreports_model extends CI_Model {
	...
	public function get_all_sub_list($cat_id){
		...
		public function get_attendanceports(){
			...
			$curl = curl_init();
				curl_setopt_array($curl, array(
				CURLOPT_URL => API_MAIN_URL.'reports/frtattendancedatartr',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
		...
		public function get_task_dump_reportdata(){
		   ...
		   /* Insert Change Log history */
			...
			$curl = curl_init();
				curl_setopt_array($curl, array(
				CURLOPT_URL => API_MAIN_URL.'reports/frtteamtaskdumpreportdata',
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => '',
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 0,
